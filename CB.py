...
if st.session_state.models_loaded:
    ...
    # Add disclaimer message at the bottom
    st.markdown("---")
    st.caption("⚠️ This is not a conversational AI. It is designed solely for event ticketing queries. Responses outside this scope may be inaccurate.")
